...
public class UserObjectActivity extends MnuboAbstractActivity {
    ...
    private void fetchUserObject() {
        if (!TextUtils.isEmpty(this.objectId)) {
            this.mnuboApi.getSmartObjectOperations().findObject(SdkId.build(objectId, IdType.objectid), new CompletionCallBack<SmartObject>() {
                @Override
    ...
    private void updateObject() {
        ...
        switch (this.objectModel) {
            case phone:
                ...
                mnuboApi.getSmartObjectOperations().update(SdkId.build(this.objectId, IdType.objectid), phone.getSmartObject(), new CompletionCallBack<Boolean>() {
                    @Override
