...
public class AddAttributeDialog extends DialogFragment {
                ...
                .setPositiveButton(R.string.add, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (currentSmartObject == null) {
                            mnuboApi.getSmartObjectOperations().findObject(SdkId.build(objectId, IdType.objectid), new MnuboApi.CompletionCallBack<SmartObject>() {
                                @Override
    ...
    private void addAttributeToObject(final SmartObject object, final Attribute newAttribute) {
        ...
        mnuboApi.getSmartObjectOperations().update(SdkId.build(this.objectId, IdType.objectid), object, new
